...
![first screen](screenshots/first_screen_1.png)

## The display screen(to display items)
![second screen](screenshots/second_screen_1.png)


## Source code

![first screen](screenshots/src_code_1.png)

![first screen](screenshots/src_code_2.png)

![first screen](screenshots/src_code_3.png)
